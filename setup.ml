...
(* OASIS_START *)
(* DO NOT EDIT (digest: e7bd1b4d1afe986657b89534f7b279fc) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("openflow",
                               Some (OASISVersion.VGreaterEqual "0.8.0"));
                           FindlibPackage
                             ("ocamlgraph",
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\171\011\020\031\162\168\206\230\196\231\192\192\222+3\230";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
