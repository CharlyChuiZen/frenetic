...
(* OASIS_START *)
(* DO NOT EDIT (digest: 14dceb6ff794df205c71a893ae1d7aee) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-cflags"; "-w,-40,-short-paths"];
     test =
       [
          ("all_tests",
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$testtool", ["inline-test-runner"; "netkat"]))
                   ];
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["https://github.com/frenetic-lang/frenetic/contributors"];
          homepage = None;
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the frenetic.quickcheck library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the netkat.async library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ocamlgraph",
                               Some (OASISVersion.VGreater "1.8.5"));
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Flowterp"; "NetKAT_FDD"; "NetKAT_Vlr"; "Util"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Parser"; "Quotations"; "MyLexer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "netkat";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "netkat";
                           FindlibPackage ("openflow", None);
                           FindlibPackage ("openflow.async", None);
                   ...
                   {
                      lib_modules =
                        ["Async_NetKAT"; "Async_NetKAT_Controller"; "NetKAT"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Discovery"; "Learning"; "Raw_app"; "TUtil"];
                      lib_findlib_parent = Some "netkat";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "netkat";
                           FindlibPackage ("openflow.quickcheck", None);
                           FindlibPackage ("packet.quickcheck", None);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_updates.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\021\031ащ5\127s\159Xъ╖х\150\142Н╬";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
